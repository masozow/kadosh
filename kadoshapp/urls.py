...
url(r'^Productos/Navegar/marca/$', viewWebProductos.avanzar_retroceder_productos_marca, name='NavegarMarcaProductosWeb'),
url(r'^Productos/Navegar/genero/$', viewWebProductos.avanzar_retroceder_productos_genero, name='NavegarGeneroProductosWeb'),
