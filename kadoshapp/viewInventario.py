...
def BuscarProducto(request):
    if request.method == 'POST':
        ...
        if txt_codigo_barras and txt_codigo_producto and id_bodega_que_vende!= 0 and id_marca_producto !=0 and id_estilo_producto !=0 and id_tipo_producto !=0 and id_talla_producto !=0 and id_color_producto != 0 and id_genero_producto !=0:
        ...
        elif txt_codigo_barras and txt_codigo_producto and id_bodega_que_vende!= 0 and id_marca_producto !=0 and id_tipo_producto !=0 and id_talla_producto !=0 and id_color_producto != 0 and id_genero_producto !=0:
            resp_producto=Producto.objects.filter(codigobarras_producto=txt_codigo_barras,codigoestilo_producto=txt_codigo_producto,marca_id_marca=id_marca_producto,tipo_producto_idtipo_producto=id_tipo_producto,talla_idtalla=id_talla_producto,color_idcolor=id_color_producto,genero_idgener=id_genero_producto,estado_producto=1,inventarioproducto__bodega_idbodega__pk=id_bodega_que_vende).values('pk','inventarioproducto__pk','nombre_producto','codigoestilo_producto','marca_id_marca__nombre_marca','genero_idgener__nombre_genero','talla_idtalla__nombre_talla','color_idcolor__nombre_color','inventarioproducto__existencia_actual','estilo_idestilo__nombre_estilo','tipo_producto_idtipo_producto__nombre_tipoproducto')
            #sin estilo
        elif txt_codigo_barras and txt_codigo_producto and id_bodega_que_vende!= 0 and id_marca_producto !=0 and id_talla_producto !=0 and id_color_producto != 0 and id_genero_producto !=0:
            ...
            #sin estilo, sin tipo
        elif txt_codigo_barras and txt_codigo_producto and id_bodega_que_vende!= 0 and id_marca_producto !=0 and id_talla_producto !=0 and id_genero_producto !=0:
        ...
        elif txt_codigo_barras and txt_codigo_producto and id_bodega_que_vende!= 0 and id_marca_producto !=0 and id_talla_producto !=0:
            resp_producto=Producto.objects.filter(codigobarras_producto=txt_codigo_barras,codigoestilo_producto=txt_codigo_producto,marca_id_marca=id_marca_producto,talla_idtalla=id_talla_producto,estado_producto=1,inventarioproducto__bodega_idbodega__pk=id_bodega_que_vende).values('pk','inventarioproducto__pk','nombre_producto','codigoestilo_producto','marca_id_marca__nombre_marca','genero_idgener__nombre_genero','talla_idtalla__nombre_talla','color_idcolor__nombre_color','inventarioproducto__existencia_actual','estilo_idestilo__nombre_estilo','tipo_producto_idtipo_producto__nombre_tipoproducto')
            #sin estilo, sin tipo, sin color, sin genero
        elif txt_codigo_barras and txt_codigo_producto and id_bodega_que_vende!= 0 and id_marca_producto !=0:
            resp_producto=Producto.objects.filter(codigobarras_producto=txt_codigo_barras,codigoestilo_producto=txt_codigo_producto,marca_id_marca=id_marca_producto,estado_producto=1,inventarioproducto__bodega_idbodega__pk=id_bodega_que_vende).values('pk','inventarioproducto__pk','nombre_producto','codigoestilo_producto','marca_id_marca__nombre_marca','genero_idgener__nombre_genero','talla_idtalla__nombre_talla','color_idcolor__nombre_color','inventarioproducto__existencia_actual','estilo_idestilo__nombre_estilo','tipo_producto_idtipo_producto__nombre_tipoproducto')
            #sin estilo, sin tipo, sin color, sin genero, sin talla
        elif txt_codigo_barras and id_bodega_que_vende!= 0 and id_marca_producto !=0:
            resp_producto=Producto.objects.filter(codigobarras_producto=txt_codigo_barras,marca_id_marca=id_marca_producto,estado_producto=1,inventarioproducto__bodega_idbodega__pk=id_bodega_que_vende).values('pk','inventarioproducto__pk','nombre_producto','codigoestilo_producto','marca_id_marca__nombre_marca','genero_idgener__nombre_genero','talla_idtalla__nombre_talla','color_idcolor__nombre_color','inventarioproducto__existencia_actual','estilo_idestilo__nombre_estilo','tipo_producto_idtipo_producto__nombre_tipoproducto')
            #sin estilo, sin tipo, sin color, sin genero, sin talla, sin codigo estilo
        elif txt_codigo_barras and id_bodega_que_vende!= 0:
            resp_producto=Producto.objects.filter(codigobarras_producto=txt_codigo_barras,estado_producto=1,inventarioproducto__bodega_idbodega__pk=id_bodega_que_vende).values('pk','inventarioproducto__pk','nombre_producto','codigoestilo_producto','marca_id_marca__nombre_marca','genero_idgener__nombre_genero','talla_idtalla__nombre_talla','color_idcolor__nombre_color','inventarioproducto__existencia_actual','estilo_idestilo__nombre_estilo','tipo_producto_idtipo_producto__nombre_tipoproducto')
            #sin estilo, sin tipo, sin color, sin genero, sin talla, sin codigo estilo, sin marca
        elif id_bodega_que_vende!= 0 and txt_codigo_producto:
            ...
            #sin estilo, sin tipo, sin color, sin genero, sin talla, sin marca, sin codigo barras
        else:
