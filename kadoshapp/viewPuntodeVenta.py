...
def BuscarProductoCaracteristicas(request):
    if request.method == 'POST':
        ...
        elif txt_codigo_producto and id_bodega_que_vende!= 0 and id_marca_producto !=0 and id_estilo_producto !=0 and id_tipo_producto !=0 and id_color_producto != 0 and id_genero_producto !=0:
            resp_producto=Producto.objects.filter(codigoestilo_producto=txt_codigo_producto,marca_id_marca=id_marca_producto,estilo_idestilo=id_estilo_producto,tipo_producto_idtipo_producto=id_tipo_producto,color_idcolor=id_color_producto,genero_idgener=id_genero_producto,estado_producto=1,inventarioproducto__bodega_idbodega__pk=id_bodega_que_vende,precio__estado_precio=1).values('pk','nombre_producto','marca_id_marca__nombre_marca','talla_idtalla__nombre_talla','color_idcolor__nombre_color','genero_idgener__nombre_genero','inventarioproducto__pk','precio__valor_precio','precio__pk','estilo_idestilo__nombre_estilo','codigoestilo_producto').order_by('-precio__pk')
        elif txt_codigo_producto and id_bodega_que_vende!= 0 and id_marca_producto !=0 and id_estilo_producto !=0 and id_tipo_producto !=0 and id_color_producto != 0:
            resp_producto=Producto.objects.filter(codigoestilo_producto=txt_codigo_producto,marca_id_marca=id_marca_producto,estilo_idestilo=id_estilo_producto,tipo_producto_idtipo_producto=id_tipo_producto,color_idcolor=id_color_producto,estado_producto=1,inventarioproducto__bodega_idbodega__pk=id_bodega_que_vende,precio__estado_precio=1).values('pk','nombre_producto','marca_id_marca__nombre_marca','talla_idtalla__nombre_talla','color_idcolor__nombre_color','genero_idgener__nombre_genero','inventarioproducto__pk','precio__valor_precio','precio__pk','estilo_idestilo__nombre_estilo','codigoestilo_producto').order_by('-precio__pk')
        elif txt_codigo_producto and id_bodega_que_vende!= 0 and id_marca_producto !=0 and id_tipo_producto !=0 and id_color_producto != 0:
            resp_producto=Producto.objects.filter(codigoestilo_producto=txt_codigo_producto,marca_id_marca=id_marca_producto,tipo_producto_idtipo_producto=id_tipo_producto,color_idcolor=id_color_producto,estado_producto=1,inventarioproducto__bodega_idbodega__pk=id_bodega_que_vende,precio__estado_precio=1).values('pk','nombre_producto','marca_id_marca__nombre_marca','talla_idtalla__nombre_talla','color_idcolor__nombre_color','genero_idgener__nombre_genero','inventarioproducto__pk','precio__valor_precio','precio__pk','estilo_idestilo__nombre_estilo','codigoestilo_producto').order_by('-precio__pk')
        elif txt_codigo_producto and id_bodega_que_vende!= 0 and id_marca_producto !=0 and id_tipo_producto !=0:
            resp_producto=Producto.objects.filter(codigoestilo_producto=txt_codigo_producto,marca_id_marca=id_marca_producto,tipo_producto_idtipo_producto=id_tipo_producto,estado_producto=1,inventarioproducto__bodega_idbodega__pk=id_bodega_que_vende,precio__estado_precio=1).values('pk','nombre_producto','marca_id_marca__nombre_marca','talla_idtalla__nombre_talla','color_idcolor__nombre_color','genero_idgener__nombre_genero','inventarioproducto__pk','precio__valor_precio','precio__pk','estilo_idestilo__nombre_estilo','codigoestilo_producto').order_by('-precio__pk')
