    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if rec_es_cotizacion==0 and rec_contado_venta==0:
                cuentaNueva=CuentaPorCobrar(venta_idventa=ventaNueva,saldo_inicial_cuentaporcobrar=rec_total_venta,fecha_pagofinal_cuentaporcobrar=datetime.date.today())
                cuentaNueva.save()
